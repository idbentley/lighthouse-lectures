...
const fetchDataForUser = function(url, username, callback) {
    request(url, (err, response, body) => {
        if (err) {
            ...
            callback(null, bodyJSON.users[username]);
        }

    })
};

// fetchDataForUser('https://gist.githubusercontent.com/kvirani/f7d65576cc1331da1c98d5cad4f82a69/raw/4baad7566f0b6cd6f651c5d3558a015e226428b5/data.json', '', undefined);
